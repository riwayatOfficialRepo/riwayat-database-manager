/**
 * Migration: Rename chat_entities.entity_type value ADMIN_TEAM -> TEAM
 * and update chat_entity_type enum accordingly.
 */

exports.up = (pgm) => {
  // Replace enum type with new value set that uses TEAM.
  pgm.sql(`
...
exports.down = (pgm) => {
  // Rollback enum and data mapping TEAM -> ADMIN_TEAM.
  pgm.sql(`
