exports.up = (pgm) => {
  ...
  // has_food_license flag — kitchens and kitchens_staging
  pgm.sql(`ALTER TABLE kitchens ADD COLUMN IF NOT EXISTS has_food_license boolean DEFAULT false`);
  pgm.sql(`ALTER TABLE kitchens_staging ADD COLUMN IF NOT EXISTS has_food_license boolean DEFAULT false`);
};
...
exports.down = (pgm) => {
  ...
  pgm.sql(`ALTER TABLE kitchens DROP COLUMN IF EXISTS has_food_license`);
  pgm.sql(`ALTER TABLE kitchens_staging DROP COLUMN IF EXISTS has_food_license`);
};
