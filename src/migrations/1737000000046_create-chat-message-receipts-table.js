...
exports.up = (pgm) => {
  ...
  // Indexes
  pgm.createIndex("chat_message_receipts", "message_id", {
    name: "idx_chat_message_receipts_message_id",
    ifNotExists: true,
  });
  pgm.createIndex("chat_message_receipts", "participant_id", {
    name: "idx_chat_message_receipts_participant_id",
    ifNotExists: true,
  });
  ...
  pgm.createIndex(
    "chat_message_receipts",
    ["message_id", "participant_id", "status"],
    {
